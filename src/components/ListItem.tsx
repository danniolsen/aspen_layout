    ...
    <View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Item
            item={item}
            navigateToDetails={(item) => goToDetails(item)}
            component={component}
          />
        )}
...
const EmptyItem = () => {
  return (
    <View style={styles.emptyItemContainer}>
      <Font size={24} variant="light" color="tertiary">
        No items found
      </Font>
    </View>
  );
      ...
      >
        <View style={styles.content}>
          <View style={styles.tagItem}>
            <Tag tag={item.tag} icon={{ materialIconName: "house" }} />
          </View>
          <View style={styles.tagItem}>
            <Tag tag={item.rating} icon={{ materialIconName: "star-border" }} />
          </View>
        </View>
      </ImageBackground>
    </View>
